...
def get_args():
    ...
    parser.add_argument('--dataset_filename', type=str, default='LTCC_ReID')
    ...
    parser.add_argument('--test_batch', default=128, type=int,
                        help="test batch size")#128
    parser.add_argument('-j', '--num_workers', default=4, type=int,
                        help="number of data loading workers")#8
    parser.add_argument('--num_instances', type=int, default=4,
                        help="number of instances per identity")#8
    ...
    parser.add_argument('--stage1_epoch', default=20, type=int,
                        help="maximum epochs to run")
    parser.add_argument('--st1_lr', default=1e-6, type=float,
                        help="initial learning rate")#0.00035
    ...
    parser.add_argument('--print_train_info_epoch_freq', type=int, default=1,
    ...
    parser.add_argument("--clip_update_parameters", type=list, default=["prompt_deep","prompt_text_deep"])#,"ln_post","visual.proj","cloth_class_embedding","softmax_model",,"sie_embed"
    parser.add_argument('--LOSS_CLA_S', type=int, default=16)
    parser.add_argument('--LOSS_EPSILON', type=int, default=0.)#0.1
    
    parser.add_argument('--ablation', default="no", type=str,
                        choices=['onlyfeat','featandall','allandinv','nomask','featandclo','VLP','noattr','nomaskandnoattr'],
