...
#     ['Face'],
#     # clothes
#     ['Hair','Left-arm', 'Right-arm', 'Left-leg', 'Right-leg', 'Left-shoe', 'Right-shoe','Hat', 'Glove', 'Sunglasses', 'Upper-clothes', 'Dress', 'Coat', 'Socks', 'Pants', 'Jumpsuits', 'Scarf', 'Skirt'],
#     #background
#     ['Background']
# ]
# MASK_MAP = [
...
#     # clothes
#     ['Hair', 'Left-shoe', 'Right-shoe','Hat', 'Glove', 'Sunglasses', 'Upper-clothes', 'Dress', 'Coat', 'Socks', 'Pants', 'Jumpsuits', 'Scarf', 'Skirt'],
#     #background
#     ['Background']
# ]
...
def read_person_mask(mask_path):
    ...
    mask_out = np.zeros([mask_array.shape[0],mask_array.shape[1]],dtype=np.bool_)#3,
    # for i in range(0,3):
    #     for label in MASK_MAP[i]:
    #         s = mask_array == LIP_LABEL.index(label)
    #         mask_out[i] = np.bitwise_or(mask_out[i],s)
    
    for label in MASK_MAP[1]:
        s = mask_array == LIP_LABEL.index(label)
        mask_out = np.bitwise_or(mask_out,s)
